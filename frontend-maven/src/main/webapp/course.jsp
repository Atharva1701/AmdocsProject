...
<body>
	...
	<div class="col-lg-3"></div>
		...
		<div class="card">
			<div class="card-body">
				<b><h3 class="card-title text-center">Add New Course</h3></b>
			<form action="course" method="POST" class="form-style">
			...
			<div class="form-group">
				...
				<input class="form-control" type="number" name="c_fees" required/>
			</div>
			<div class="form-group">
				<label for="date">Course Description</label>
				<input class="form-control" type="text" name="c_desp" required/>
			</div>
			<div class="form-group">
				<label for="resource">Course Resources</label>
				<input class="form-control" type="text" name="c_resource" required/>
			</div>
			<button type="submit" class="btn btn-success reg">Add Course</button>
		</form>
			</div>
		</div>
		</div>
